...
<!-- Rafael -->
[PIPPA](https://pippa.agrinc.vib.be/pippa-public) [@https://pippa.agrinc.vib.be/pippa-public] is a data management system used for collecting data from the Weighing, Imaging and Watering Machines ([WIWAM](https://www.wiwam.be/)) [@https://www.wiwam.be], which are a range of automated high-throughput phenotyping platforms. 
